...
export default function Menu() {
    return (
        <div className={styles.fsuHolder}>
            ...
            <p className={styles.largerText}>Created by <Link href='https://geoset.fsu.edu'><a className={styles.promoLink}>GEOSET</a></Link> in collaboration with <Link href='https://math.fsu.edu'><a  className={styles.promoLink} >FSU Math</a></Link></p>
